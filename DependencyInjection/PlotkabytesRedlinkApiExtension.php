...
namespace Plotkabytes\RedlinkApiBundle\DependencyInjection;
...
class PlotkabytesRedlinkApiExtension extends Extension
{
    const PATH_ALIAS = 'plotkabytes_redlink_api';
