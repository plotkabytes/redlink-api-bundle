...
namespace Plotkabytes\VercomApiBundle\Tests\DependencyInjection;

use Http\Client\HttpClient;
use PHPUnit\Framework\TestCase;
use Plotkabytes\VercomApi\DefaultClient;
use Plotkabytes\VercomApiBundle\DependencyInjection\PlotkabytesVercomApiExtension;
use Symfony\Component\Config\Definition\Exception\InvalidConfigurationException;
use Symfony\Component\DependencyInjection\ContainerBuilder;
use Symfony\Component\DependencyInjection\Definition;
use Symfony\Component\HttpClient\MockHttpClient;

class PlotkabytesVercomApiExtensionTest extends TestCase
{
    ...
    private $container;
    /**
     * @var PlotkabytesVercomApiExtension
     */
    private $extension;
    ...
    public function setUp(): void
    {
        ...
        $this->extension = new PlotkabytesVercomApiExtension();
    }
